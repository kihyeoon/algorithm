...
const uglyNumbers = function (n) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    // 5. 반복
    const nextMultipleOf2 = uglyNumbers[idx2] * 2; // 2 4 6 8 10 12 16 18 20
    const nextMultipleOf3 = uglyNumbers[idx3] * 3; // 3 6 9 12 15 18 24 27 30
    const nextMultipleOf5 = uglyNumbers[idx5] * 5; // 5 10 15 20 25 30 40 45 50
